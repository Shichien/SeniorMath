...
\begin{example}
    与直线 $3 x-4 y+5=0$ 关于坐标原点对称的直线方程为 \underline{\qquad}
\end{example}
...
\begin{tikzpicture}[
        ...
        dim_label/.style={font=\tiny, fill=white, inner sep=0.5pt}
    ]
    ...
    \coordinate (P) at (0.3*30, 0.7*20);
    \node[point] at (P) {};
    \node[label_style, below left=1pt] at (P) {$P$};
    ...
    \draw[dashed] (0,20) -- (100,20);
    \draw[dashed] (30,0) -- (30,80);
\end{tikzpicture}
