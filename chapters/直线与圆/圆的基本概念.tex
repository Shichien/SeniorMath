...
\begin{example}
    ...
    \begin{itemize}
        \item $\lambda$ 的取值范围为 $(-\infty, 5]$
        \item 若已知 $P(1,0)$ 在圆内，则 $\lambda<-3$
        \item 若 $\lambda=3$ ，则直线 $x+y+1=0$ 与圆 $C$ 相离
        \item 若 $\lambda=1$ ，圆 $C$ 关于直线 $x+y+1=0$ 对称的圆 $D$ 方程为 $x^2+y^2+6 x+5=0$
    \end{itemize}
\end{example}
...
\begin{solution}
    ...
    由 $\left\{\begin{array}{l}x-1=0, \\ x^2+y^2-2 y=0,\end{array}\right.$

    解得 $\left\{\begin{array}{c}x=1, \\ y=1 .\end{array}\right.$
