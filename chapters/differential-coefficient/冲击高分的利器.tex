...
\begin{theorem}
    $$ \text{令} h(x)=\ln(1+x)-\frac{x}{1+x}(x>0), \text{则} h(x)=\frac{1}{1+x}-\frac{1}{(1+x)^2}=\frac{x}{(1+x)^2}>0 $$

    $$ \therefore h(x) \text{在} (0,+\infty) \text{上单调递增}，\therefore h(x)>h(0)=0 \text{，即} \ln(1+x)>\frac{x}{1+x} $$

    则 $\ln 1.04>\frac{0.04}{1.04}=\frac{4}{104}$ ，即 $b>a$ ；
\end{theorem}
