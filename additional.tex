...
\setCJKmainfont{SimSun.ttc}[
    ...
    ItalicFont = KaiTi.ttf, % 中文斜体使用楷体
    BoldItalicFont = SimHei.ttf
]

% 该定义用于 section (思源宋体粗体、图表标题粗体)
\newCJKfontfamily{\siyuansongbold}[Path=fonts/]{SourceHanSerifCN-SemiBold.otf}
\newCJKfontfamily{\kaiti}[Path=fonts/]{KaiTi.ttf}
...
\newtcolorbox{warning}{
    ...
    bottom=1.8pt,
    right=5em,
    fontupper=\fontsize{9.5pt}{13pt}\selectfont\kaiti,
...
\newtcolorbox{tips}{
    ...
    bottom=1.8pt,
    right=5em,
    fontupper=\fontsize{9.5pt}{13pt}\selectfont\kaiti, % 内容字体: {大小}{衬线}
    fonttitle=\small\bfseries,
    title={
            \faLightbulb[regular]
            \hspace{1.5pt}
